...
This is a thin wrapper for TensorFlow's `space_to_depth` operation with a fixed block size of 2. It reorganizes spatial data into the depth (channel) dimension, which is used in YOLO v2 to concatenate features from different scales.
...
<ResponseField name="output_shape" type="tuple">
...
<ResponseField name="outputs" type="tuple">
